        ...
        <div className="container mx-auto flex justify-between items-center px-4">
          ...
          {!isMobile && (
            <div className="flex items-center gap-2">
              ...
              <SocialButton
                href="https://www.linkedin.com/in/ashish-kushwaha-45201b179/"
                icon={<Linkedin className="h-4 w-4" />}
                label="LinkedIn"
              />
              <SocialButton
                href="https://discord.com/users/developer_ashish"
                icon={
              ...
              />
              <SocialButton
                href="https://www.youtube.com/@developerashish6849"
                icon={<Youtube className="h-4 w-4" />}
                label="YouTube"
              />
              <SocialButton
                href="https://www.instagram.com/developer_ashish.py/"
                icon={<Instagram className="h-4 w-4" />}
                label="Instagram"
              />
              <SocialButton
                href="https://github.com/pydeveloperashish"
